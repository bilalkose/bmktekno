					...
					<div class="card-columns">
						...
						<div class="card product-card">
							...
							<div class="card-footer text-center">
								...
								<button class="btn btn-outline-success"><%=p.getPriceAfterApplyingDiscount()%>
									₺<span class="text-secondary discount-label">%<%=p.getpDiscount()%> indirim</span>
									<!--<%=p.getpPrice() %> orjinal fiyat -->
								</button>
							</div>
						</div>
